		...
		public int validacaoCompra(int qtdIngressosVen) {
			try {
				...
				if(qtdIngressos >= qtdIngressosVen) {
					...
					System.out.println("A quantidade de ingressos vendidos foi de: " + qtdIngressosVen + " e estão disponíveis ainda: " + qtdIngressos);

				}else {					
					System.out.println("Nao há ingressos suficientes");
